"""Add scheduled task run history table.

Revision ID: r3m4n5o6p789
Revises: q2l3m4n5o678
...
revision = "r3m4n5o6p789"
down_revision = "q2l3m4n5o678"
branch_labels = None
depends_on = None


def upgrade() -> None:
    """Create persisted scheduler run history storage."""
    op.create_table(
        "scheduled_task_runs",
